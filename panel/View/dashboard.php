            ...
            <div id="detail-header" class="ResourceDetailsLayout__Header" style="display:none">
                ...
                <div id="detail-buttons" class="ResourceDetailsButtons">
                    ...
                    <div id="detail-stop" class="ToolbarButton normal disabled" role="button" tabindex="0">
                        <div class="ToolbarButton__icon"><div class="Icon layout vertical center-center crossCircle" style="width:22px;height:22px"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><path class="colorable" fill="white" fill-rule="evenodd" d="M12 0c6.624 0 12 5.376 12 12s-5.376 12-12 12S0 18.624 0 12 5.376 0 12 0zm5 5H7v14h10V5z"/></svg></div></div><?= __('Stop') ?>
                    </div>
            ...
            <div id="terminal-header">
                ...
                <div class="terminal-actions">
                    ...
                    <div id="btn-stop" class="ToolbarButton normal disabled" role="button" tabindex="0">
                        <div class="ToolbarButton__icon"><div class="Icon layout vertical center-center" style="width:22px;height:22px"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><path class="colorable" fill="white" fill-rule="evenodd" d="M12 0c6.624 0 12 5.376 12 12s-5.376 12-12 12S0 18.624 0 12 5.376 0 12 0zm5 5H7v14h10V5z"/></svg></div></div><?= __('Stop') ?>
                    </div>
